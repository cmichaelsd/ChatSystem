...
abstract class AbstractDynamoRegistry(protected val dynamoClient: DynamoDbClient) {
    protected abstract val tableName: String
    protected abstract val partitionKey: String

    private val logger = LoggerFactory.getLogger(AbstractDynamoRegistry::class.java)
