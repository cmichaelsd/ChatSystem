...
5) For image update in ECS (if needed): `aws ecs update-service --cluster chatsystem --service chatsystem-apiserver --force-new-deployment --profile chatsystem --region us-west-1`
